...
class PolisViewSecurityListPage extends StatelessWidget {
  ...
  WTR buildWTRRow(Polis3CrudModel item) {
    ...
    WTD wtd1 = WTD(flex: 7, child: Text(rekanNama, style: TextStyle(color: Colors.black,))) ;
    WTD wtd2 = WTD(
        child: Row(
          children: [
            const Spacer(),
            Text(NumberFormat("##0.00").format(sharePersen), style: TextStyle(color: Colors.black,)),
          ],
        ),
        flex: 4);
